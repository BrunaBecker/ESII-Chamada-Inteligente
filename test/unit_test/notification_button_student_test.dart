...
void main() {
  ...
  group('Student: Validates notification button', () {
    testWidgets('[S] Go to Notification page', (WidgetTester tester) async {
      // Run the app
      app.main();
      await tester.pumpAndSettle();
    ...
    testWidgets('[S] Back from Notification page', (WidgetTester tester) async {
      // Run the app
      app.main();
      await tester.pumpAndSettle();
